...
// 1. KONEKSI DB
// Sesuaikan path jika berbeda (misal: ../../../config/koneksi.php)
...
if (isset($_POST['simpan'])) {
    ...
    if($foto_nama != "") {
        // Buat nama unik (contoh: 170988_ayam.jpg)
...
<head>
    ...
    <style>
        ...
        .img-preview {
            max-width: 100%;
            max-height: 100%;
            display: none; /* Sembunyi dulu sebelum ada gambar */
            object-fit: contain;
        }
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <footer class="sticky-footer bg-white">
                <div class="container my-auto">
                    <div class="copyright text-center my-auto"><span>Copyright &copy; D'Bubuy Ma'Atik 2025</span></div>
                </div>
            </footer>
        </div>
    </div>
